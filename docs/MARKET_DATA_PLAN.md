...
## ✅ COMPLETED: Phase 1-2 (by OpenClaw)
...
| Task | Status | Location |
|------|--------|----------|
| `/api/market/global` endpoint | ✅ Done | `routes/market.py` |
| `/api/market/dominance` endpoint | ✅ Done | `routes/market.py` |
| Global Stats UI | ✅ Done | Market Pulse panel |
| BTC Dominance mini-data | ✅ Done | `routes/market.py` |
...
├── templates/
│   └── dashboard.html        ← Add new panels
├── static/
│   ├── style.css              ← Add new styles
│   └── app.js                 ← Add new functions
├── services/
